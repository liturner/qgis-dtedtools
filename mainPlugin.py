...
class DTEDTools:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&DTED Tools')
    ...
    def add_action(
        ...
        if add_to_menu:
            self.iface.addPluginToMenu("DTED Tools", action)
    ...
    def unload(self):
        for action in self.actions:
            self.iface.removePluginMenu(u'DTED Tools', action)
    ...
    def run(self):
        ...
        # show the dialog
        self.dlg = SRTMtoDTEDDialog(self.iface)
        self.dlg.show()
